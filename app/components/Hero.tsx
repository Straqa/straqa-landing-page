    ...
    return(
        <div className="w-full bg-[#F7F9FC]">
            ...
            <div className="text-center h-full px-[20px] py-[50px]">
                ...
                <p className="text-[#8492A7] text-lg md:text-2xl font-medium mt-5 md:mt-10">Everything you need to take your business online, boost sales, and manage operations—all in one platform.</p>
