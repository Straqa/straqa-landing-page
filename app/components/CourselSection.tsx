  ...
  return (
    <div className='w-full h-[450px] overflow-hidden bg-black relative'>
      <AnimatePresence>
        {coursel[activeIndex] && (
          <motion.div
            className={`h-full w-full bg-black absolute top-0 left-0 bg-center bg-cover bg-no-repeat bg-fixed`}
            ...
            <div className='h-full w-full bg-black/70 px-[20px] md:px-[100px] lg:px-[150px] py-10 flex items-center'>
              <div className='flex-1 space-y-7'>
                <h1 className='text-3xl md:text-5xl font-semibold text-white'>
                  {coursel[activeIndex].title}
                </h1>
                <p className='text-[#667185] text-lg md:text-2xl font-medium text-white max-w-[850px]'>
                  {coursel[activeIndex].subText}
                </p>
              </div>
