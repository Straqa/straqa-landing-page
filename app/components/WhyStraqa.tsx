...
const reasons: { title: string; icon: string; subText: string }[] = [
  {
    ...
    subText:
      "Automate operations, track performance, and make data-driven decisions effortlessly.",
  },
  {
    icon: "/icons/chart.svg",
    title: "Online Store & E-Commerce Setup",
    subText:
      "Easily create and manage an online store to sell products and services without coding.",
  },
  {
    icon: "/icons/send.svg",
    title: "Seamless Payment Integration",
    subText:
      "Accept payments securely from multiple channels, including mobile money and bank transfers.",
  },
  {
    icon: "/icons/flag.svg",
    title: "Smart Marketing & Customer Engagement",
    subText:
      "Use AI-driven insights to run targeted marketing campaigns and grow your customer base.",
  },
  {
    icon: "/icons/chart-star.svg",
    title: "Automated Order & Delivery Management",
    subText:
      "Streamline logistics, track orders, and manage deliveries efficiently.",
  },
  {
    icon: "/icons/bulb.svg",
    title: "Business Analytics & Insights",
    subText:
      "Get real-time reports, sales trends, and AI-powered recommendations to optimize growth.",
  },
  {
    icon: "/icons/edit.svg",
    title: "Multi-Industry Adaptability",
    subText:
      "Suitable for retail, restaurants, transport, event ticketing, and other business types.",
  },
  {
    icon: "/icons/menu.svg",
    title: "User-Friendly & No Tech Expertise Needed",
    subText:
      "Simple and intuitive platform designed for business owners with no technical background.",
  },
];
